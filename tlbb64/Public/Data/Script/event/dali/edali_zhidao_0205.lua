...
x210205_g_SceneID=2
x210205_g_AccomplishNPC_Name="钱龙"
...
--任务名
x210205_g_MissionName="认识新朋友"
x210205_g_MissionInfo="#{event_dali_0008}"
x210205_g_MissionTarget="在#G大理城五华坛#W找到四大善人之一的#R钱龙#W#{_INFOAIM145,139,2,钱龙}。#b#G（请用左键点选带下划线的坐标，帮助您找到该NPC）#l"
x210205_g_MissionComplete="#{event_dali_0009}"
x210205_g_MoneyBonus=1
x210205_g_SignPost = {x = 145, z = 138, tip = "钱龙"}

x210205_g_Custom	= { {id="已找到钱龙",num=1} }
...
function x210205_OnAccept( sceneId, selfId )
	...
	Msg2Player(  sceneId, selfId,"#Y接受任务：认识新朋友",MSG2PLAYER_PARA )
...
function x210205_OnSubmit( sceneId, selfId, targetId, selectRadioId )
	if x210205_CheckSubmit( sceneId, selfId, selectRadioId ) == 1 then
		...
		Msg2Player(  sceneId, selfId,"#Y完成任务：认识新朋友",MSG2PLAYER_PARA )
