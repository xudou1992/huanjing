...
x210225_g_SceneID=2
x210225_g_AccomplishNPC_Name="段延庆"
...
--任务名
x210225_g_MissionName="段延庆"
x210225_g_MissionInfo="#{event_dali_0035}"
x210225_g_MissionTarget="在#G大理城东南方的玉洱巷#W找到#R段延庆#W#{_INFOAIM215,284,2,段延庆}。#b#G（请用左键点选带下划线的坐标，帮助您找到该NPC）#l"
x210225_g_MissionComplete="#{event_dali_0036}"
x210225_g_MoneyBonus=72
x210225_g_SignPost = {x = 215, z = 284, tip = "段延庆"}

x210225_g_Custom	= { {id="已找到段延庆",num=1} }
x210225_g_IsMissionOkFail = 1		--变量的第0位
...
function x210225_OnAccept( sceneId, selfId )
	...
	Msg2Player(  sceneId, selfId,"#Y接受任务：段延庆",MSG2PLAYER_PARA )
...
function x210225_OnSubmit( sceneId, selfId, targetId, selectRadioId )
	if x210225_CheckSubmit( sceneId, selfId, selectRadioId ) == 1 then
		...
		Msg2Player(  sceneId, selfId,"#Y完成任务：段延庆",MSG2PLAYER_PARA )
