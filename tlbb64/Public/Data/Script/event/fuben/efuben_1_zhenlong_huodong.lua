...
x401001_g_endTime1 = 12 * 60 + 00;

x401001_g_beginTime2 = 12 * 60 + 05;
x401001_g_endTime2 = 23 * 60;
...
x401001_g_createMonsterIntervalInfoList = {
										{topPressStep=40, intervalTickCount=5},
										{topPressStep=80, intervalTickCount=4},
