...
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${NC}"
echo -e "  ${BLUE}ℹ${NC} 日常管理（在 ${YELLOW}$INSTALL_DIR${NC} 目录执行）:"
echo -e "      ${YELLOW}./install.sh start${NC}     启动服务端"
echo -e "      ${YELLOW}./install.sh stop${NC}      关闭服务端（安全停服+日志打包）"
echo -e "      ${YELLOW}./install.sh status${NC}    查看进程状态"
echo -e "      ${YELLOW}./install.sh restart${NC}   重启服务端"
